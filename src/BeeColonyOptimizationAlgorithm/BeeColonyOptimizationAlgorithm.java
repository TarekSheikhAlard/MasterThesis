 ...
 * @author Tarek
 */
public class BeeColonyOptimizationAlgorithm {
    ...
    BeeColonyOptimizationInstance BCOI;
    public BeeColonyOptimizationAlgorithm(int PopulationSize) throws SQLException, ParseException
    {
            ...
            BCOI = new BeeColonyOptimizationInstance(PopulationSize);
           // BCOI.Run(100);
    }
    
    
    public void Run(int Iteration) throws SQLException, ParseException
    {
        BCOI.Run(Iteration);
    }
    
    public double [] getSolution() {return  BCOI.GetSolution();}
    ...
    public static void main(String arg[]) throws SQLException, ParseException {
        ...
        BeeColonyOptimizationAlgorithm bca = new BeeColonyOptimizationAlgorithm(10);
     //   bca.PrintResult();
     }
}
