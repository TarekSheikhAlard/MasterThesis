...
import DifferentialEvolutionAlgorithm.DifferentialEvolutionInstance;
...
public class MemeticAlgorithm {
  SqlOperation SO;
    ...
    public MemeticAlgorithm(int Populaion) throws SQLException, ParseException
    {
     ...
     //   System.out.println("Parameters.chromosomeLength: "+Parameters.chromosomeLength);
        MA = new MemeticInstance(Populaion,Parameters.chromosomeLength);
    }
    ...
    {
       Solution =MA.MemeticAlgorithm(Iterations,NumberofNeighbors);
    }
